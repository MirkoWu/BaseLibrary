 ...
 * @date on 2017/10/24
 * @describe 大致为2种模式：
 * 1.设置沉浸式透明状态栏 然后增加一个statusBar高度的padding
 * 2.设置fitsSystemWindows=true 使顶部增加一个statusBar高度的padding ，
 * 然后在activity根部局（FrameLayout）中加入一个等高的矩形遮盖原有的statusBar颜色 可对矩形设置透明度和颜色
 */
